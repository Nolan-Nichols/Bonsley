...
function displayImageThumbs(fileObj){
...
//This nasty function takes a file object and calls the upload script to store recipe images in the respective directory
function uploadFiles(fileObj){
	...
	xml.open("POST", "php/recipeImageUploader.php");
