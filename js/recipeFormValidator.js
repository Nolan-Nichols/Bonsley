...
function submitFormData(){
	...
	//Array var for steps
	var steps = document.getElementsByName("stepDescription[]");
	...
	//Copy data from old steps array into new onerror
	var numSteps = steps.length;
	var newSteps = [numSteps];
	
	for(var i = 0; i < numSteps; i++){
		
		newSteps[i] = steps[i].value;
